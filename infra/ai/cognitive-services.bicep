...
@description('The built in roles available for role assignments.')
...
@description('Do we want to enable local authentication with account keys?')
...
@description('The location of the Cognitive Service.')
param location string = resourceGroup().location

@description('The resource tags of the Cognitive Service.')
param resourceTags object = {}

@description('Whether public network access is allowed for the Cognitive Service. This should be disabled for security reasons.')
@allowed([
  'Enabled'
  'Disabled'
])
...
@description('The ID of the deployed Cognitive Service.')
...
@description('The endpoint of the deployed Cognitive Service.')
output cognitiveServiceEndpoint string = cognitiveService.properties.endpoint

@description('The built in roles available for role assignments.')
output cognitiveServiceRoles object = builtInRoleNames
